        ...
        <div className="w-full h-auto text-white  bg-gradient-to-t from-[#000000] to-[#1E1E1E]  align justify-center text-center py-11 gap-8">
            ...
            <div className="py-5 ">
                <details className="group">
                    <summary className=" m-auto w-44 flex cursor-pointer list-none items-center text-center font-medium rounded-full bg-black px-10 py-3 text-sm text-white transition hover:bg-white hover:text-black border hover:border-black hover:font-medium focus:outline-none focus:bg-white focus:text-black focus:border-black focus:font-medium">
...
<br></br>
                        ...
                        <div className="w-2/3 h-auto m-auto gap bg-[#262626] rounded-2xl">
                            <p className=" text-white/100 align justify-center p-4 font-extralight ">
                                <b>As melhores noites de sono com o conforto de colchões dos hotéis de luxo, agora em sua própria casa.</b> 
                                <br></br>
                                <br></br>
