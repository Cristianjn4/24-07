    ...
    <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0 pt-28">
      <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
        ...
        <div class="mt-6 sm:mt-8 lg:mt-0">
          ...
          <p className="pt-4">
          <img alt="" src="https://www.portalsimmons.com.br/source/files/c/2864/pulse-627051_80-80-0-0.jpg" />
          </p>
          <p className="pt-4">
          <img alt="" src="https://www.portalsimmons.com.br/source/files/c/3324/Icone_D26-394493_80-80-0-0.jpg"  />
          </p>
          <p className="pt-4">
          ...
          <p>Pulse Natural<br/> Latex</p> <p>Espuma de <br/> acolhida macia  </p> <p>Visco</p>
          </div>
          <p>&nbsp;</p>
          ...
          <p>
          Sua primorosa combinação de materiais nobres e tecnologias diferenciadas, proporcionará momentos indescritíveis para as suas noites.          </p>
                <br/><br/>
          ...
          <p dir="ltr">Altura: 41cm</p>

          <p dir="ltr">N&iacute;vel de conforto &rarr; Super Macio</p>

          <p dir="ltr">Tecido da capa: Nobre tecido em malha composta por fios de Viscose de Microtencel de suave toque (72% Poliéster / 28% Viscose).</p>

          <p dir="ltr">Tecido da faixa lateral: Tecido em Linho Brooks Cinza 370g (100% Poliéster).</p>

          <p dir="ltr">Tecnologias: Pulse Natural Latex, Espuma de acolhida macia, Visco, Beautyrest Evo</p>
