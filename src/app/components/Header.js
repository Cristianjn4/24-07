...
export default function Header() {
    return(
      ...
      <div className="lg:hidden md:hidden z-10">


      <nav class="fixed top-10 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 ">
      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                  <li>
                     <a href="/products#colchoes" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Colchões</a>
                  </li>
                  <li>
                     <a href="/products" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Camas</a>
                  </li>
                  <li>
                     <a href="/products" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Travesseiros</a>
                  </li>
                  <li>
                     <a href="/products" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Acessórios</a>
                  </li>
            </ul>
         </li>
         <li>
