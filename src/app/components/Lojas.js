...
<section className="sm:grid sm:grid-cols-2 sm:items-center mr-40 ml-40">
  ...
  <div  className="p-5 md:p-12 lg:px-16 lg:py-24">
    <div id="mapsLocate" className="mx-2  ltr:sm:text-left rtl:sm:text-right align items-center text-center ">
      ...
      <div className="mx-auto mt-1 grid max-w-xl divide-y divide-neutral-200 ">
            <div className="py-5 ">
                <details className="group">
                    <summary className=" m-auto w-96 flex cursor-pointer list-none items-center text-center font-medium rounded-md bg-black px-10 py-3 text-sm text-white transition hover:bg-white hover:text-black border hover:border-black hover:font-medium focus:bg-white focus:text-black focus:border-black focus:font-medium focus:outline-none">
