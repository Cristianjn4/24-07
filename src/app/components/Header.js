      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                  <li>
                     <a href="/products" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Colchões</a>
                  </li>
                  <li>
