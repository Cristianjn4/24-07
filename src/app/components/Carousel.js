...
<div id="default-carousel" class="relative w-full mt-16 lg:hidden md:hidden" data-carousel="slide">
    {/* Carousel wrapper */}
    <div class="relative  h-56 overflow-hidden rounded-lg md:h-96">
        ...
        {/* Item 2 */}
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <video src="./banner-rotativo-.mp4" type="video.mp4" autoPlay muted loop className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="Troca solidária"/>
        </div>
        {/* Item 3 */}
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
