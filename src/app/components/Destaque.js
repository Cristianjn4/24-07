    ...
    return(
        <div className="">
             <div className="pt-32 md:p-12 lg:px-16 lg:py-24 align items-center text-center bg-gray-100 pb-10">
                ...
                <img src="logoR.png" className="m-auto w-44 mb-5 rounded-full" />
                
                <p className="px-8 font-medium text-lg text-black pt-4 ">
                <h3 className="text-3xl px-8 font-bold text-black py-4">
                    Destaque Loja Perfeita Simmons
                </h3> 
                Conheça a Simmons Casa Orner e tenha melhor experiência na escolha do seu colchão ideal!<br/>
