    ...
    <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0 pt-28">
      <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
        ...
        <div className="text-white bg-stone-900 rounded-lg w-auto m-4 px-3 absolute text-center"> Frete Grátis </div>
          ...
          <img class="w-full dark:hidden" src="Marbella.png" alt="" />
        </div>

        <div class="mt-6 sm:mt-8 lg:mt-0">
          <h1 className="text-3xl font-extrabold text-gray-900  dark:text-white">
            Colchão Simmons Marbella
          </h1>
          ...
          <div class="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
            <a
              href="https://api.whatsapp.com/send?phone=5511995379301&text=Ol%C3%A1,%20gostaria%20de%20saber%20mais%20sobre%20o%20colch%C3%A3o%20*Simmons%20Marbella.*"
              target="blank"
              title=""
            ...
            <a
              href="https://www.portalsimmons.com.br/source/files/originals/CO_MARBELLA_2022-4CPRA_LPTIN32-329398.pdf"
              target="blank"
              title=""
          ...
          <p className="pt-4">
          <img alt="ANTIÁCARO" src="https://www.portalsimmons.com.br/source/files/c/3321/Icone_Visco-776069_80-80-0-0.jpg" title="ANTIÁCARO" />
          </p>
          <p className="pt-4">
          <img alt="Argentum (Simmons)" src="https://www.portalsimmons.com.br/source/files/c/3339/Icone_Bamboo_Touch-274055_80-80-0-0.jpg" title="Argentum (Simmons)" />
          </p>
          <p className="pt-4">
          <img alt="Argentum (Simmons)" src="https://www.portalsimmons.com.br/source/files/c/1559/Espumas-426814_80-80-0-0.jpg" title="Argentum (Simmons)" />
          </p>
          </div>
          <div className="flex text-justify text-xs font-light gap-10">
          <p>Tecido antiácaro</p> <p>Bamboo Touch</p> <p>Espuma de alta <br/> performance D33 </p> 
          </div>
          <p>&nbsp;</p>

          <p dir="ltr" className="font-bold">SOBRE O PRODUTO:</p>

          <p dir="ltr">&quot;EDe conforto firme, o Simmons Marbella tem visco na capa e as molas LFK 2.2</p>
          ...
          <p dir="ltr" className="font-bold">CARACTER&Iacute;STICAS:</p>

          <p dir="ltr" >Altura: 32cm</p>

          <p dir="ltr">N&iacute;vel de conforto &rarr; Firme</p>

          <p dir="ltr">Tecido da capa: Malha Bamboo Touch de toque suave (83% Poliéster, 17% Viscose).</p>

          <p dir="ltr">Tecido da faixa lateral: Tecido lateral em Original Suede Marfim (100% Poliéster).</p>

          <p dir="ltr">Tecnologias → Top Visco inside, Bamboo Touch, Espuma de alta performance D33, Posturest LFK2.2</p>

          <p dir="ltr">Molejo → Molejo LFK com bitola de 2.2mm, 224 molas por m 2 e suporte médio de 1.457Kg/m 2</p>
